...
const ChemistVistingAdmin = () => {
  ...
  useEffect(() => {
    fetch(`${BASE_URL}/api/chemists/visits`)
      .then((res) => res.json())
      .then((data) => {
        setVisits(data);
  ...
  const handleUserCardClick = (userId) => {
    navigate(`/admin-dashboard/chemist-visits/${userId}`);
  };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 text-center">
          <h1 className="text-4xl font-bold text-gray-900 flex items-center justify-center gap-3">
            <span className="text-indigo-600">💊</span> Chemist Visits Dashboard
          </h1>
        </div>
...
export default ChemistVistingAdmin;